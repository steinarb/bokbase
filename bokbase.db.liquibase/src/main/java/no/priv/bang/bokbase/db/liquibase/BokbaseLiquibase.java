...
public class BokbaseLiquibase {

    public void createInitialSchema(Connection connection) throws LiquibaseException {
        applyLiquibaseChangelist(connection, "bokbase-db-changelog/db-changelog-1.0.0.xml");
    }

    public void updateSchema(Connection connection) throws LiquibaseException {
        applyLiquibaseChangelist(connection, "bokbase-db-changelog/db-changelog-1.0.1.xml");
    }

    public void forceReleaseLocks(Connection connection) throws LiquibaseException {
        Liquibase liquibase = createLiquibaseInstance(connection, "bokbase-db-changelog/db-changelog-1.0.0.xml");
