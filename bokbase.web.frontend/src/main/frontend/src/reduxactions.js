...
export const BOOK_ISBN13_MODIFY = createAction('BOOK_ISBN13_MODIFY');
...
export const BOOK_PUBLISHED_DATE_MODIFY = createAction('BOOK_PUBLISHED_DATE_MODIFY');
...
export const BOOK_FINISHED_READ_DATE_MODIFY = createAction('BOOK_FINISHED_READ_DATE_MODIFY');
