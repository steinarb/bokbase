 ...
 * under the License.
 */
package no.priv.bang.bokbase.web.frontend;
...
public class BokbaseServletTest {

    @Test
    public void testGet() throws Exception {
        MockLogService logservice = new MockLogService();
        BokbaseServlet servlet = new BokbaseServlet();
        ...
        when(request.getRequestURI()).thenReturn("http://localhost:8181/bokbase/useradmin/");
    ...
    public void testDoGetAddTrailingSlash() throws Exception {
        ...
        HttpServletRequest request = mock(HttpServletRequest.class);
        when(request.getMethod()).thenReturn("GET");
        when(request.getRequestURL()).thenReturn(new StringBuffer("http://localhost:8181/bokbase/useradmin"));
    ...
    public void testDoGetResourceNotFound() throws Exception {
        ...
        HttpServletRequest request = mock(HttpServletRequest.class);
        when(request.getMethod()).thenReturn("GET");
        when(request.getRequestURI()).thenReturn("http://localhost:8181/bokbase/useradmin/static/nosuchname.png");
