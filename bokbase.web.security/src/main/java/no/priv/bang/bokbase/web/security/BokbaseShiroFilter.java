 ...
 * under the License.
 */
package no.priv.bang.bokbase.web.security;
 ...
 * be put in front of the servlets in the "/bokbase" webcontext, and
...
public class BokbaseShiroFilter extends AbstractShiroFilter { // NOSONAR
    ...
    static {
        ...
        INI_FILE.load(BokbaseShiroFilter.class.getClassLoader().getResourceAsStream("shiro.ini"));
    }
